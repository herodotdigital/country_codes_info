...
public class SwiftCountryCodesInfoPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "country_codes_info", binaryMessenger: registrar.messenger())
    let instance = SwiftCountryCodesInfoPlugin()
